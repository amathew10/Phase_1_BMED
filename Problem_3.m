%Akash Mathew
%ECE 4784Ste
%Problem 3 Constant current excitation
...
%injected current
I(1:length(t)) = 5; %pulse of length 100 ms at 5 micro amps.
...
V_m = V_m + V_rest;%offset V_m by the resting membrane voltage
